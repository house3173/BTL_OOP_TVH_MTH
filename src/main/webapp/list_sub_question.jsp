...
<div class="container" style="border: 1.5px solid #ebebeb; border-radius:5px; height:auto; margin-top:20px; padding: 20px 25px;">
	...
	<form action="" method="get" id="form_select_category">
		...
		<%
			String getIdCate = session.getAttribute("getIdCategoryListQuestion")+"";
		...
		<div class="form-check">
			  <input class="form-check-input" type="checkbox" value="" id="question_subcategory" name="question_subcategory" onclick="window.location.href = 'list_question.jsp';" checked>
	...
	<%
		...
		if (getIdCate.equals("0") || getIdCate.equals("null")) {} else {
			...
			category cateselected = catedao.selectCategoryById(getidcate);
	 ...
	 <div class="listquestion">
		...
		<form action="change_question" method="post" id = "edit_question">
		  <div style="padding: 6px; display:flex; justify-content:space-between; align-items:baseline; background-color:<%=color%>;">
		  	<input type="hidden" name="edit_question" value="list_sub_question">
